...
const Autenthification = () => {
  ...
  useEffect(() => {
    ...
    google.accounts.id.initialize({
      client_id:
        "698638413623-40gu5f9rmbsjgnd4u42o5npbvcurn94u.apps.googleusercontent.com",
      callback: handleCallbackResponse,
    });
    google.accounts.id.renderButton(document.getElementById("icon-google"), {
      theme: "outline",
      size: "large",
    });
  }, []);
  ...
  return (
    <div>
      {
       users!==0 ?(
        <Principal dropComponent = {setUser}/>
       ) : 
       (
        <section id="contain">
        <div className="contenus">
          ...
          <button className="connectSpotify">
            <a
